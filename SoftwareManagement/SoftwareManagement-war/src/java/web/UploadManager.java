    ...
    public void upload() {
        ...
        if (file != null) {
            try {
                ...
                FacesMessage message = new FacesMessage("Ficheiro  \"" + file.getFileName() + "\" enviado com sucesso!");
                FacesContext.getCurrentInstance().addMessage(null, message);

            } catch (IOException e) {
                FacesMessage message = new FacesMessage("ERRO: Ficheiro \"" + file.getFileName() + "\" não enviado!");
                FacesContext.getCurrentInstance().addMessage(null, message);
            }
        }
    }
